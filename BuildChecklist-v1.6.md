...
# Version: 1.6 | Updated: 2026-04-22
...
- [x] Services bento grid (9 cards — 8 services + Website in 3 Days)
...
- [x] Website in 3 Days service section added ✅

### Pricing page
- [x] Website in 3 Days block (first block, R850/£40 setup, R299/£15 monthly) ✅
...
- [x] FAQ section
- [x] "Remember" banner
- [!] Pricing figures — DEFERRED — founder to confirm GBP amounts for all services
...
- [x] /website-in-3-days landing page (hero, features + pricing, intake form)
- [x] Intake form — 6 plain-English fields
- [x] Drag-and-drop file upload — 4MB limit, images and PDFs only
- [x] Form submission → mitesh@bpolytix.com via Resend with attachment ✅
- [x] Double-submit bug fixed — single POST after FileReader resolves ✅

### Integrations
- [x] Resend: domain verified ✅
- [x] Resend: contact form → mitesh@bpolytix.com ✅
- [x] Resend: website brief form → mitesh@bpolytix.com with attachment ✅
- [x] Tawk.to: widget on all pages ✅
- [x] WhatsApp: floating button bottom-left, desktop only ✅
- [x] Vercel Analytics — @vercel/analytics/next in layout.tsx ✅
- [!] Tawk.to customisation — DEFERRED to Phase 3
- [!] WhatsApp Business API — DEFERRED to Phase 3
- [!] File upload migration to Supabase Storage — DEFERRED to Phase 2 (API route only)
...
- [ ] File upload migration — /api/website-brief updated to use Supabase Storage (frontend untouched)
...
- [ ] SA Rand pricing added alongside GBP on all service pages
- [ ] DMARC policy tighten — change p=none to p=quarantine once sending volume confirmed
- [ ] Resend from address — change no-reply to real mailbox (advisory from Resend Insights)
...
| File upload Phase 2 | Supabase Storage — API route change only, frontend untouched | 2026-04-22 |
...
| 4 | 2026-04-22 | Resend integration, Tawk.to widget, WhatsApp floating button, DMARC record | Website in 3 Days page, Vercel Analytics |
| 5 | 2026-04-22 | Website in 3 Days page, service cards, pricing block, file upload, Vercel Analytics | Animation pass, About page, Legal page |
