...
export function HeroSection() {
  ...
  return (
    <section
      ...
      style={{ backgroundColor: "#0A0F1A", paddingTop: "96px", paddingBottom: "128px" }}
    >
      <GrainOverlay />
      <div
        className="relative z-10 mx-auto grid max-w-[1440px] grid-cols-1 gap-12 px-8 lg:grid-cols-[60%_40%] lg:gap-8"
      >
        {/* Left */}
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="rounded-full px-6 py-3 text-[15px] font-medium text-white transition-transform hover:-translate-y-px"
              style={{
            ...
            <Link
              href="/services"
              className="rounded-full px-6 py-3 text-[15px] font-medium transition-colors hover:bg-white/10"
              style={{
        ...
        <div className="relative flex flex-col items-center justify-center">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(50% 50% at 50% 40%, rgba(27,119,242,0.18) 0%, rgba(27,119,242,0) 70%)",
            }}
          />
            ...
            <div className="relative">
              <span
                ...
                style={{
                  ...
                  height: 16,
                  backgroundColor: "#1B77F2",
                  boxShadow: "0 0 20px rgba(27,119,242,0.6)",
                }}
              />
              <span
          ...
          >
            <div className="flex items-center gap-2 border-b border-white/[0.06] pb-3 mb-3">
              ...
              <span className="ml-2 text-[11px]" style={{ color: "#8892A4" }}>
                build.status
              </span>
            </div>
            <div>
            ...
            <div>
              <span style={{ color: "#8892A4" }}>build:</span>{" "}
              <span style={{ color: "#F5F7FA" }}>in progress</span>
            </div>
            <div>
              <span style={{ color: "#8892A4" }}>delivery:</span>{" "}
              <span style={{ color: "#F5F7FA" }}>28 days</span>
            </div>
            <div>
              <span style={{ color: "#8892A4" }}>invoice:</span>{" "}
              <span style={{ color: "#00D4AA" }}>$0.00</span>
            </div>
          </div>
        </div>
      </div>
